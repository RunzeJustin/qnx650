...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template name="bar">
    <xsl:param name="width"/>
      <img src="/qnx-coverage/report/bar.gif" style="align: left; width: {$width};height: 15px;border: none"/>
  </xsl:template>
  
  <xsl:template name="indent">
      <xsl:param name="level"/>
      <img src="/qnx-coverage/report/blank.gif" style="width: {$level * 20};height: 15px;border: 2px;border-color: #000000"/>
  </xsl:template>
</xsl:stylesheet>
