...
class CreateHardlinkTest(BaseTest):
    ...
    def test_add_hardlink(self):
        ...
        if sys.platform == "qnx6":
            # On a qnx4 fs, doing a hard link changes the inode number
            # of the existing file, which trips this test
            print "qnx4 fs changes ino of existing file on hard link"
            return
