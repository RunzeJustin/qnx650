/*
 * $QNXLicenseC:
 * Copyright 2007, 2010, QNX Software Systems. All Rights Reserved.
 * 
...
extern void  *_list_alloc(_CSTD size_t);
extern void  *_list_memalign(_CSTD size_t __align, _CSTD size_t __size);
...
extern int _select_band(size_t alignment, size_t size, unsigned *vp, Band** pp);
...
extern pthread_once_t  __malloc_once;
