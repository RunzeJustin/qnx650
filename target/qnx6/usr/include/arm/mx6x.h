...
#define MX6X_ANADIG_REG_CORE                    0x140 /* TODO: No Doc? */
...
#define CSCMR1_SSI2_CLK_SEL_PLL4                (0x1 << 12)
#define SSI2_CLK_DIV_MASK                      (0x1ff)
#define SSI2_CLK_PRED(x)                        ((x & 7) << 6)
#define SSI2_CLK_PODF(x)                        ((x & 0x3f) << 0)
/*
...
/* __SRCVERSION( "$URL: http://svn/product/branches/6.5.0/SP1/hardware/startup/lib/public/arm/mx6x.h $ $Rev: 648519 $" ) */
