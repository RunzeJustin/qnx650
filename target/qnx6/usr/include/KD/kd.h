/* Reference KD/kd.h for OpenKODE Core 1.0.2  */
#ifndef __kd_h_
#define __kd_h_
...
#ifdef KD_QNX_window
        KDEventWindowCreateQNX windowcreateqnx;
        KDEventWindowPropertyQNX windowpropertyqnx;
        KDEventWindowRealizeQNX windowrealizeqnx;
        KDEventWindowCloseQNX windowcloseqnx;
#endif /* KD_QNX_window */
#endif /* KD_WINDOW_SUPPORTED */
#ifdef KD_QNX_input
        KDEventKeyboardQNX keyboardqnx;
#endif /* KD_QNX_input */
        KDEventUser user;
    } data;
};
