...
__extension__ enum Elf_mips_e_flags {
...
enum elf_mips_e_r {
	...
	R_MIPS_GLOB_DAT	= 51,
	R_MIPS_LOVENDOR = 100,
	R_MIPS_COPY = 126,		/* Extension. Don't conflict with MIPS16 relocs */
...
__SRCVERSION( "$URL: http://svn/product/branches/6.5.0/trunk/lib/elf/public/sys/elf_mips.h $ $Rev: 295686 $" )
#endif
