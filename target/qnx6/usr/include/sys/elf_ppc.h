...
__extension__ enum Elf_ppc_e_flags {
...
__extension__ enum Elf_ppc_s_flags {				/* sh_flags */
...
__SRCVERSION( "$URL: http://svn/product/branches/6.5.0/trunk/lib/elf/public/sys/elf_ppc.h $ $Rev: 249147 $" )
#endif
