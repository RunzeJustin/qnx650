...
int snd_ctl_open_name(snd_ctl_t **handle, char *filename);
...
int snd_mixer_open_name(snd_mixer_t **handle, char *filename);
...
#define	PLUGIN_DISABLE_BUFFER_PARTIAL_BLOCKS	(1<<0)
#define	PLUGIN_DISABLE_MMAP						(1<<1)
...
__SRCVERSION( "$URL: http://svn/product/branches/6.5.0/trunk/lib/asound/public/include/sys/asoundlib.h $ $Rev: 230206 $" )
