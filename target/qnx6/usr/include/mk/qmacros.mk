...
oses=qnx4 nto solaris win32 linux unix $(EXTRA_OS_NAMES)
...
metasrcs=$(foreach dir, $1, $(addprefix $(dir)/*., s S c cc cpp $(EXTRA_SUFFIXES)))
lib_path = $(foreach path_opt, $(if $(LD$(LINKER_TYPE)_PATHOPT_$(COMPILER_DRIVER)),$(LD$(LINKER_TYPE)_PATHOPT_$(COMPILER_DRIVER)),-L), $(addprefix $(path_opt) , $(LIBVPATH)))
...
define TARGET_HINSTALL
	$(PRE_HINSTALL)
	@-$(foreach dir, $(PUBLIC_INCVPATH), $(foreach file, $(shell $(FL_HOST) $(dir)), $(CP_HOST) $(file) $(INSTALL_ROOT_HDR)/$(patsubst $(dir)/%,%,$(file));))
	$(POST_HINSTALL)
endef
