...
#endif
typedef void (GL_APIENTRYP PFNGLVERTEXATTRIB4FARBPROC) (GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
typedef void (GL_APIENTRYP PFNGLPROGRAMENVPARAMETER4FARBPROC) (GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
typedef void (GL_APIENTRYP PFNGLPROGRAMENVPARAMETER4FVARBPROC) (GLenum target, GLuint index, const GLfloat *params);
typedef void (GL_APIENTRYP PFNGLPROGRAMLOCALPARAMETER4FARBPROC) (GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
typedef void (GL_APIENTRYP PFNGLPROGRAMLOCALPARAMETER4FVARBPROC) (GLenum target, GLuint index, const GLfloat *params);
typedef void (GL_APIENTRYP PFNGLVERTEXATTRIB4XIMGPROC) (GLuint index, GLfixed x, GLfixed y, GLfixed z, GLfixed w);
typedef void (GL_APIENTRYP PFNGLPROGRAMLOCALPARAMETER4XIMGPROC) (GLenum target, GLuint index, GLfixed x, GLfixed y, GLfixed z, GLfixed w);
typedef void (GL_APIENTRYP PFNGLPROGRAMLOCALPARAMETER4XVIMGPROC) (GLenum target, GLuint index, const GLfixed *params);
typedef void (GL_APIENTRYP PFNGLPROGRAMENVPARAMETER4XIMGPROC) (GLenum target, GLuint index, GLfixed x, GLfixed y, GLfixed z, GLfixed w);
typedef void (GL_APIENTRYP PFNGLPROGRAMENVPARAMETER4XVIMGPROC) (GLenum target, GLuint index, const GLfixed *params);
typedef void (GL_APIENTRYP PFNGLVERTEXATTRIBPOINTERARBPROC) (GLuint index, GLsizei size, GLenum type, GLboolean normalized, GLsizei stride, const GLvoid *pointer);
...
typedef void (GL_APIENTRYP PFNGLPROGRAMSTRINGARBPROC) (GLenum target, GLenum format, GLsizei len, const void *string);
typedef void (GL_APIENTRYP PFNGLBINDPROGRAMARBPROC) (GLenum target, GLuint program);
typedef void (GL_APIENTRYP PFNGLDELETEPROGRAMARBPROC) (GLsizei n, const GLuint *programs);
