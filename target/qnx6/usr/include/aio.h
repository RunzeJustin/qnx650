...
extern int lio_listio64(int __mode, struct aiocb64 *__restrict __const __list[], int __nent, struct sigevent *__restrict __sig);
...
__SRCVERSION( "$URL: http://svn/product/branches/6.5.0/SP1/lib/c/public/aio.h $ $Rev: 235780 $" )
