 ...
 */
#define PPC_MSR_GS		_ONEBIT32B( 3 ) /* E500 */
...
#define PPC_460EX	0x1302

#define PPC_E500	0x8020
#define PPC_E500V2	0x8021
#define PPC_E500MC	0x8023
...
__SRCVERSION( "$URL: http://svn/product/branches/6.5.0/SP1/services/system/public/ppc/cpu.h $ $Rev: 236860 $" )
#endif
