...
#define PPC85xx_INTR_IRQ0			(PPC_INTR_CLASS_85xx +32)
#define PPC85xx_INTR_IRQ1			(PPC_INTR_CLASS_85xx +33)
#define PPC85xx_INTR_IRQ2			(PPC_INTR_CLASS_85xx +34)
#define PPC85xx_INTR_IRQ3			(PPC_INTR_CLASS_85xx +35)
#define PPC85xx_INTR_IRQ4			(PPC_INTR_CLASS_85xx +36)
#define PPC85xx_INTR_IRQ5			(PPC_INTR_CLASS_85xx +37)
#define PPC85xx_INTR_IRQ6			(PPC_INTR_CLASS_85xx +38)
#define PPC85xx_INTR_IRQ7			(PPC_INTR_CLASS_85xx +39)
#define PPC85xx_INTR_IRQ8			(PPC_INTR_CLASS_85xx +40)
#define PPC85xx_INTR_IRQ9			(PPC_INTR_CLASS_85xx +41)
#define PPC85xx_INTR_IRQ10			(PPC_INTR_CLASS_85xx +42)
#define PPC85xx_INTR_IRQ11			(PPC_INTR_CLASS_85xx +43)

#define PPC85xx_INTR_IPI0			(PPC_INTR_CLASS_85xx +44)
#define PPC85xx_INTR_IPI1			(PPC_INTR_CLASS_85xx +45)
#define PPC85xx_INTR_IPI2			(PPC_INTR_CLASS_85xx +46)
#define PPC85xx_INTR_IPI3			(PPC_INTR_CLASS_85xx +47)

#define PPC85xx_INTR_GT0			(PPC_INTR_CLASS_85xx +48)
#define PPC85xx_INTR_GT1			(PPC_INTR_CLASS_85xx +49)
#define PPC85xx_INTR_GT2			(PPC_INTR_CLASS_85xx +50)
#define PPC85xx_INTR_GT3			(PPC_INTR_CLASS_85xx +51)

#define PPC85xx_INTR_MSG0			(PPC_INTR_CLASS_85xx +52)
#define PPC85xx_INTR_MSG1			(PPC_INTR_CLASS_85xx +53)
#define PPC85xx_INTR_MSG2			(PPC_INTR_CLASS_85xx +54)
#define PPC85xx_INTR_MSG3			(PPC_INTR_CLASS_85xx +55)
...
__SRCVERSION( "$URL: http://svn/product/branches/6.5.0/SP1/hardware/startup/lib/public/ppc/85xxintr.h $ $Rev: 648519 $" )
#endif
