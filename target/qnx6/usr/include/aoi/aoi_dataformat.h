...
#define AOIFOURCC(FCC) ((FCC[0]<<24)|(FCC[1]<<16)|(FCC[2]<<8)|FCC[3])
...
__SRCVERSION( "$URL: http://svn/product/branches/6.5.0/trunk/lib/aoi/public/aoi/aoi_dataformat.h $ $Rev: 279929 $" )
#endif
