...
*   is simply directed to @c stderr. @c The mtouch_log() output format is:
...
*
*   This macro implements a mtouch_log() function with severity of @c SLOG_DEBUG.
...
*   @c stderr. @c The mtouch_log() output format is:
...
*
*   This macro implements a mtouch_log() function with severity of @c SLOG_INFO.
*   If @c NDEBUG is defined, the information is sent as a message to the
*   system logger (@c slogger). Otherwise, the log is simply directed to
*   @c stderr. @c The mtouch_log() output format is:
...
*
*   This macro implements a mtouch_log() function with severity of @c SLOG_WARNING.
*   If @c NDEBUG is defined, the information is sent as a message to the
*   system logger (@c slogger). Otherwise, the log is simply directed to
*   @c stderr. @c The mtouch_log() output format is:
...
*
*   This macro implements a mtouch_log() function with severity of @c SLOG_ERROR.
*   If @c NDEBUG is defined, the information is sent as a message to the
*   system logger (@c slogger). Otherwise, the log is simply directed to
*   @c stderr. @c The mtouch_log() output format is:
