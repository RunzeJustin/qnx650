...
/**
 * @brief Retrieve mtouch event data from a screen event
 *
 ...
 * @param screen_abs The indicator to specify which coordinates to use; @c 1
 *                   indicates to use Screen coordinates. Otherwise, use source
 *                   viewport.
 *
