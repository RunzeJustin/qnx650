...
extern bool_t	xdr_u_int16_t	__P((XDR *, uint16_t *));
extern bool_t	xdr_int32_t	__P((XDR *, int32_t *));
extern bool_t	xdr_u_int32_t	__P((XDR *, uint32_t *));
extern bool_t	xdr_int64_t	__P((XDR *, int64_t *));
extern bool_t	xdr_u_int64_t	__P((XDR *, uint64_t *));
...
extern bool_t	xdr_hyper	__P((XDR *, int64_t *));
extern bool_t	xdr_u_hyper	__P((XDR *, uint64_t *));
extern bool_t	xdr_longlong_t	__P((XDR *, int64_t *));
extern bool_t	xdr_u_longlong_t __P((XDR *, uint64_t *));
__END_DECLS
...
__SRCVERSION( "$URL: http://svn/product/branches/6.5.0/trunk/lib/rpc/public_nto/rpc/xdr.h $ $Rev: 219996 $" )
