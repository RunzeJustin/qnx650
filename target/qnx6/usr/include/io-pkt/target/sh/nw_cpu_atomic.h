...
#ifndef _SH_NW_CPU_ATOMIC_H_INCLUDED
#define _SH_NW_CPU_ATOMIC_H_INCLUDED
...
#endif /* !_SH_NW_CPU_ATOMIC_H_INCLUDED */

__SRCVERSION( "$URL: http://svn/product/branches/6.5.0/SP1/lib/io-pkt/sys/target/sh/nw_cpu_atomic.h $ $Rev: 233581 $" )
