...
enum {
	...
	*/
	...
	/** A single integer that indicates the pointer wheel associated with
	...
	*/
	...
	/** An integer that is a color to be used with the
	*   @c SCREEN_TRANSPARENCY_TEST, @c SCREEN_TRANSPARENCY_REVERSED_TEST
	*   and @c SCREEN_TRANSPARENCY_COLOR modes; a property of a window or
	*   display object.
	*
...
enum {
	...
	*/
	...
	/** Destination pixels are replaced by source pixels when the pixel value
	...
	*   the color does not match the reference color value; see
