...
--        inc_usr_spec_id = unique"/fs/ipod";  -- does rsrcdbmgr_devno_attach
    ...
    class(USB_CLASS_HID) {
        driver"io-fs-media -dipod,transport=usb:busno=$(busno):devno=$(devno):audio=/dev/snd/ipod-$(busno)-$(devno),darates=+8000:11025:12000:16000:22050:24000,playback,acp=i2c:addr=0x11:path=/dev/i2c3:speed=50000,fnames=short,config=/fs/mp/etc/mm/ipod.cfg,stalk,pps=/pps/services/multimedia/ipod-$(busno)-$(devno)/";
    };
